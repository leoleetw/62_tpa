		...
		<div id="about_main_nav">
            ...
            <div class="leftNav_mid">
                <ul>
                    ...
                    <a href="#" style="text-decoration:none;"><li class="nav_hover">活動剪影</li></a>
						...
						<div class="pic_table_div">
							<table class="pic_table">
								...
								<?
									...
									$pageSize = 16;
									$sql = "select * from albumtype where album_kind='活動剪影' and year(album_date)='".$data_year."' Order by Album_Date";
								...
								?>
									<div class="img_bg">
										<a href="pic_show.php?album_type=<? echo $row["Album_type"]; ?>">
