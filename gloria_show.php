		...
		<div id="about_main_nav">
            ...
            <div class="leftNav_mid">
                ...
                <a href="#" class="nav" onclick="location.href='pic.php';"><li>活動剪影</li></a>
                    <a href="#" style="text-decoration:none;" onclick="location.href='gloria';"><li class="nav_hover">光彩與榮耀</li></a>
					...
					<form id='form1' action='pic.php'>
						<div>
							...
							<table class="pic_show_info">
								<tr><td><img src="images/active_icon.png">  活動主題：</td><td><? echo $row["Album_Name"]; ?></td></tr>
								<tr><td><img src="images/active_icon.png">  活動內容：</td><td><? echo $row["Album_Desc"]; ?></td></tr>
							</table>
						</div>
